  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-sm': ['clamp(1.25rem, 2vw, 1.75rem)', { lineHeight: '1.3', letterSpacing: '-0.01em', fontWeight: '600' }],
      },
      animation: {
      ...
      boxShadow: {
        ...
        'brand': '0 10px 40px -10px rgba(0, 102, 204, 0.3)',
        'accent': '0 10px 40px -10px rgba(255, 107, 0, 0.3)',
      },
      backgroundImage: {
